...
(custom-set-variables
 ...
 '(package-selected-packages
   '(eat bongo transmission mentor ytdl osm mpv elfeed emms mermaid-mode ob-mermaid org-modern org-auto-tangle org-roam pass olivetti ement quelpa-use-package one-themes editorconfig term+ stupid-indent-mode fountain-mode vterm-toggle web-mode yaml-mode react-snippets ranger crdt go-mode multiple-cursors gruvbox-theme rustic typescript-mode lsp-mode pdf-tools magit magitt markdown-mode restclient vue-mode mbsync rainbow-mode))
